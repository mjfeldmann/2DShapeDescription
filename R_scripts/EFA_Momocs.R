...
#Modifying the threshold for each image seemed to work. 
coo.0 = import_jpg(lf[1686],threshold = 0.001)
coo.1 = import_jpg(lf[2274],threshold = 0.001)
coo.2 = import_jpg(lf[2689],threshold = 0.001)
...
coo.12 = import_jpg(lf[6284],threshold = 0.01)
